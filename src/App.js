...
const App = () => {
  const data = React.useMemo(
    () => [
      ...
      {id:24, name: 'Shree Ram Prabosh Sahu',fathername: 'Shree Bhadai Sahu',address: 'Gnagaur',donation: '15,051/-',},
      ...
      {id:32, name: 'Shree Satyanarayan Yadav',fathername: 'Late Babue Lal Mahto',address: 'Ganagur',donation: '12,500/-',},
      ...
      {id:40, name: 'Shree Devnandan Mahto',fathername: 'Late Genai Mahto',address: 'Gnagur',donation: '11,051/-',},
      {id:41, name: 'Shree Rajilal Yadav',fathername: 'Late dashai Yadav',address: 'Gangaur',donation: '11,051',},
      {id:42, name: 'Moshmat Shail Kumari Devi',fathername: 'Late Ramchandra Mishra',address: 'Gnagaur',donation: '11,051/-',},
      ...
      {id:47, name: 'Shree Ramnandan Yadav',fathername: 'Late Subodh Yadav',address: 'Gangaur',donation: '11,050/-',},
      ...
      {id:50, name: 'Shree Harishchandra prasad Yadav',fathername: 'Late Jadish Yadav',address: 'Manoharpur, Gangaur',donation: '10,800/-',},
      {id:51, name: 'Shree Shubhanshu Shubham',fathername: 'Shree Binod Kumar Yadav',address: 'Gangaur',donation: '10,551/-',},
      {id:52, name: 'Shree Vimal Mahto',fathername: 'Shree Kailash prasad kushwaha',address: 'Gangaur',donation: '10,500/-',},
      {id:53, name: 'Shree Lalan Prasad Kushwaha',fathername: 'Shree Kailash prasad kushwaha',address: 'Ganagur',donation: '10,500/-',},
      {id:54, name: 'Shree Shankar Prasad',fathername: 'Late Jahauli Mahto',address: 'Gangaur',donation: '10,051/-',},
      {id:55, name: 'Shree Kailash Prasad Veram',fathername: 'Late Jahauli Mahto',address: 'Ganagur',donation: '10,000/-',},
      {id:56, name: 'Shree Ram Rijhan Prasad',fathername: 'Late Sobhit Mahto',address: 'Gangaur',donation: '8,000/-',},
      {id:57, name: 'Shrre Liladhar Sahu',fathername: 'Shree Bhadai sahu',address: 'Ganagaur',donation: '7,551/-',},
      {id:58, name: 'Shree Ramkripal Mishra',fathername: 'Late Ramvilash Mishra ',address: 'Ganagur',donation: '7,551/-',},
      {id:59, name: 'Shree Saukhi Yadav',fathername: 'Late Ram Lochan Yadav',address: 'Gangaur',donation: '7,550/-',},
      {id:60, name: 'Shree Pappu kumar Yadav',fathername: 'Shree Ram Swarath Yadav',address: 'Gangaur',donation: '7,151/-',},
      {id:61, name: 'Shree Sanjeev Sah',fathername: 'Shree Shankar sah',address: 'Gangaur',donation: '7,051/-',},
      {id:62, name: 'Shree Sanjay Yadav',fathername: 'Shree Ramhit Yadav',address: 'Gangaur',donation: '6,551/-',},
      {id:63, name: 'Shree Shivnath Mahto',fathername: 'Shree Rambahadur Mahto',address: 'Gangaur',donation: '6,551/-',},
      {id:64, name: 'Shree Sandeep Kumar Mahto',fathername: 'Shree Hajari Mahto',address: 'Gangaur',donation: '6,551/-',},
      {id:65, name: 'Shree Vinay Kumar',fathername: 'Shree Ram Rantan Mahto',address: 'Gnagaur',donation: '6,501/-',},
      {id:66, name: 'Shree Bhogendra Mahto',fathername: 'Late Revi Mahto',address: 'Gangaur',donation: '6,251/-',},
      {id:67, name: 'Shree Sonfi Yadav',fathername: 'Late Uchit Yadav',address: 'Gangaur',donation: '6,161/-',},
      {id:68, name: 'Shree Jagganath Mahto ',fathername: 'Shree Ram bahadur Mahto',address: 'Gangaur',donation: '6,151/-',},
      {id:69, name: 'Shree Birendra Mahto',fathername: 'Shree Bhaglu Mahto',address: 'Gangaur',donation: '6,151/-',},
      {id:70, name: 'Shree Ganesh Mahto',fathername: 'Late Kanhai Mahto',address: 'Gangaur',donation: '6,151/-',},
      {id:71, name: 'Shree Damodar Prasad',fathername: 'Late Jagdeo Sah',address: 'Gangaur',donation: '6,105/-',},
      {id:72, name: 'Shre Shivchandra Mahto',fathername: 'Late Makeshwar Mahto',address: 'Gangaur',donation: '6,101/-',},
      {id:73, name: 'Shree Durbal Yadav',fathername: 'Late Munai Yadav',address: 'Gangaur',donation: '6,051/-',},
      {id:74, name: 'Shree Ram Sagar Mahto',fathername: 'Late Faudar Mahto',address: 'Gangaur',donation: '6,051/-',},
      {id:75, name: 'Shree Jeebachh Mishra ',fathername: 'Late Rameshwar Mishra',address: 'Gangaur',donation: '6,051/-',},
      {id:76, name: 'Shree vijay Yadav',fathername: 'Late Rambriksha Yadav',address: 'Gangaur',donation: '6,000/-',},
      ...
      {id:137, name: '* Shree Doshik Das',fathername: 'Late Sahedev Sah',address: 'Gangaur',donation: '5,151/-',},
      {id:138, name: 'Shree Rambaran mahto',fathername: 'Late Damodar Mahto',address: 'Gangaur',donation: '5,151/-',},
      {id:139, name: 'Shree Jagjeet Mahto',fathername: 'Late Dukhai Mahto',address: 'Gangaur',donation: '5,150/-',},
      ...
      {id:143, name: 'Shree Jaghdeesh Ram ',fathername: 'Shree Tetar Ram',address: 'Madhiya, Gangaur',donation: '5,101/-',},
      ...
      {id:158, name: 'Shree Chandeshwar Yadav',fathername: 'Shree Ramchandra yada',address: 'Gangaur',donation: '5,101/-',},
