...
const App = () => {
  const data = React.useMemo(
    () => [
      ...
      {id:55, name: 'Shree Kailash Prasad Verma',fathername: 'Late Jahauli Mahto',address: 'Ganagur',donation: '10,000/-',},
      {id:56, name: 'Shree Ram Rijhan Prasad',fathername: 'Late Sobhit Mahto',address: 'Gangaur',donation: '8,000/-',},
      {id:57, name: 'Shree Liladhar Sahu',fathername: 'Shree Bhadai sahu',address: 'Ganagaur',donation: '7,551/-',},
